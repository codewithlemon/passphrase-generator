...
function App() {
  ...
  function copyToClipboard() {
    navigator.clipboard.writeText(generatedPassphrase.join(""))
  }

  return (
    <div className="App">
      <div className="app-box">
        <h1 className="app-name">Passphrase Generator</h1>
        {generatedPassphrase && (
          <GeneratedPassphrase newPassphrase={generatedPassphrase} />
        )}
      ...
      <div className="app-credits">
        <a
          href="https://github.com/codewithlemon/passphrase-generator"
